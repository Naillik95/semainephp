...
<h1 class="center">Nos Jeux</h1>
        <div class="box">
            <div class="border">
                <div class="">
                    <img src="img/Fifa 2021.jpg" >
                    <div class="">
                        <button class="button black"> Acheter <i class="fa fa-shopping-cart"></i></button>
                    </div>
                    <p>FIFA 21<br><b>60€</b></p>
                </div>
            </div>

            <div class="border">
                <div class="">
                    <img src="img/smash bross.jpg" >
                    <span class=""></span>
                    <div class="">
                        <button class="button black"> Acheter <i class="fa fa-shopping-cart"></i></button>
                    </div>
                </div>
                <p>Smash Bross<br><b>60€</b></p>
            </div>
            <div class="border">
                <img src="img/Call of duty.jpg" >
                <div class="">
                    <button class="button black"> Acheter <i class="fa fa-shopping-cart"></i></button>
                </div>
                <p>Call Of Duty : Modern Warfare<br><b>60€</b></p>
            </div>
        </div>
<h1 class="center">Nos Mangas</h1>
        <div class="box">
            ...
            <div class="border">
                <div class="">
                    <img src="img/attack on titant.jpg" >
                    <span class=""></span>
                    <div class="">
                        <button class="button black"> Acheter <i class="fa fa-shopping-cart"></i></button>
                    </div>
        ...
        <div class="box">
            <div class="border">
                <div class="">
                    ...
                    <p>The Walking Dead<br><b>30€</b></p>
                </div>
            </div>
